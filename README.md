...
## Project Overview
This project is a simple serverless API for logging inventory checks and retrieving them later by ID.
...
CloudWatch Logs was used to view Lambda execution logs and troubleshoot errors.
...
### Retrieve an inventory check by ID
Method: GET  
Path: /inventory-checks/{check_id}
